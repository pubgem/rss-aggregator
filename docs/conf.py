# -*- coding: utf-8 -*-
#
# rss-aggregator documentation build configuration file, created by
...
htmlhelp_basename = 'rss-aggregatordoc'
...
latex_documents = [
    ('index', 'rss-aggregator.tex', u'rss-aggregator Documentation',
        u'pubgem', 'manual'),
]
...
man_pages = [
    ('index', 'rss-aggregator', u'rss-aggregator Documentation',
        [u'pubgem'], 1)
]
...
texinfo_documents = [
    ('index', 'rss-aggregator', u'rss-aggregator Documentation',
        u'pubgem', 'rss-aggregator', 'One line description of project.',
        'Miscellaneous'),
]
